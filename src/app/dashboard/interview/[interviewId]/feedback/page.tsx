...
function Feedback() {
  ...
  const getFeedback = async () => {
    ...
    console.log("Feedback result from db:", result);
  ...
  return (
    <div className="p-10">
      ...
      <h2 className="text-blue-500 text-lg my-3">
        Your overall interview rating : <strong>7</strong>
      </h2>

      <h2 className="text-sm text-gray-600">
        Find below the interview question with your answer, correct answer and
          ...
          <Collapsible key={index} className="mt-7">
            ...
            <CollapsibleContent>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="p-2 border rounded-lg bg-gray-50 text-sm text-gray-700">
